...
For my PhD thesis research, I explore social and environmental drivers of foraging and migratory behavior in the NE Pacific blue whale population. In this work, I focus on linking patterns of individual and population-level behavior, and connecting these patterns to regional oceanography. Blue whales provide a unique study system for questions of the interaction between environment and social and collective behavior due to (1) their ability to communicate over vast distances; (2) their low population density; (3) their highly-migratory and capital breeding life history; and (4) their extremely dynamic and expansive oceanographic habitat. 

I also interrogate the equity and viability of modern approaches to managing ecosystems and natural resources. This work includes considering human dimensions and equity in marine resource management, and understanding the viability of managing ecosystems dynamically in space and time.
